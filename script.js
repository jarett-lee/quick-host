$(function() {
  ...
  function rebuild() {
    ...
    if (hideText) {
      ...
      context.strokeText(text, (cWidth - textWidth) / 2, cHeight / 1.5);
  ...
  $('#show_button').on('click', function() {
    hideText = !hideText;
    $('#show_button').prop('value', hideText ?  "Show Text" : "Hide Text");
    rebuild();
  });

  $('#more_stuff').on('click', function() {
    batchAdd();
  });
